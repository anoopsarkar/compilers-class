...
class InteractiveShiftReduceGUI:
    ...
    def create_widgets(self):
        ...
        self.stack_label = tk.Label(stack_frame, text="[ ]", font=("Courier", 11),
                                   bg="lightblue", relief=tk.SUNKEN, anchor=tk.W)
        self.stack_label.pack(side=tk.LEFT, padx=10, fill=tk.X, expand=True)
        ...
        self.buffer_label = tk.Label(buffer_frame, text="", font=("Courier", 11),
                                    bg="lightgreen", relief=tk.SUNKEN, anchor=tk.W)
        self.buffer_label.pack(side=tk.LEFT, padx=10, fill=tk.X, expand=True)
