...
<span class="text-warning">With grace days {{ site.hwdates[1].gracedays }}</span>
...
Make sure you have already followed the [instructions in HW0](hw0.html) to set up your GitHub repository.
